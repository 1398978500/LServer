...
#define LOG_INFO is_logged(LogLevel::INFO) && NANO_LOG(LogLevel::INFO)
#define LOG_WARN is_logged(LogLevel::WARN) && NANO_LOG(LogLevel::WARN)
#define LOG_CRIT is_logged(LogLevel::CRIT) && NANO_LOG(LogLevel::CRIT)
